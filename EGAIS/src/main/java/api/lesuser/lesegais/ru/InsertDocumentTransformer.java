...
public class InsertDocumentTransformer extends AbstractMessageTransformer {

	@Override
	public Object transformMessage(MuleMessage message, String outputEncoding) throws TransformerException {

		RequestInsertDocument rid = null;
		...
		{			
			...
			{			
					//rid = new RequestInsertDocument(map, "deal");
			}
		...
		message.setInvocationProperty("m", "InsertDocument");
